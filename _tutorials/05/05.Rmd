...
-   [ggthemes](https://ggplot2.tidyverse.org/reference/ggtheme.html): Includes themes inspired by The Economist, The Wall Street Journal, FiveThirtyEight, and Tufte among others.
...
p + theme(text = element_text(family="Caveat", size=20))
```
...
```{r}
p + theme_bw(base_size=20, base_family="Caveat")
```
