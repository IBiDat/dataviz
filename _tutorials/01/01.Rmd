...
Source: [`_tutorials/01/01.Rmd`](https://raw.githubusercontent.com/IBiDat/dataviz/main/_tutorials/01/01.Rmd)

# Preliminaries

The goal of this tutorial is to provide a gentle introduction to ggplot2. We will learn to create and manipulate a ggplot object, add data, create a mapping of data to visual channels, and add layers of visual marks. The best way to follow this tutorial is by using the [RStudio](https://www.rstudio.com/) IDE, so ensure that you have it installed in your computer (along with R).
...
Another option would be to **download the [sources](https://raw.githubusercontent.com/IBiDat/dataviz/main/_tutorials/01/01.Rmd)** of this Rmd document, and use it to tinker with the chunks of code directly.
