...
```{r, include=FALSE}
if (!requireNamespace("pixture", quietly = TRUE))
  remotes::install_github("IBiDat/pixture@limit")
```

```{r, echo=FALSE, layout="l-screen"}
paths <- c(
  "projects/2025/100577218/100577218_files/figure-html5/plot_final_map-1.png",
  "projects/2025/100572199/100572199_files/figure-html5/replicate-chart-1.png",
  "projects/2025/100563749/100563749_files/figure-html5/final-replication-1.png",
  ...
  "projects/2025/100569570/100569570_files/figure-html5/unnamed-chunk-8-1.png",
...
# remotes::install_github("IBiDat/pixture@limit")
pixture::pixgallery(paths, caption=caption, shuffle=TRUE, limit=32, layout="grid")
```
