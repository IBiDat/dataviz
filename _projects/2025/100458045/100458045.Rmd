...
## Original Graph
![Original chart. Source: [Source: Flowing Data (Nathan Yau)](original_graph.png){.external width=100%}]
...
```{r final-circular-visualization, fig.width=22, fig.height=12, dpi=300, preview=TRUE}
final_layout_sidebyside
```
