...
# Map 
map_feb2023 <- bivariate_map(map_data)
```
...
```{r final-replication, fig.width = 14, fig.height = 10, preview = TRUE}
...
# Filtering and creating bi-clas
map_data_aug2025 <- map_data_aug2025 |> 
