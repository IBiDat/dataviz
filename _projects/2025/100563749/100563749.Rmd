...
output: 
  distill::distill_article:
    ...
    toc: true 
---
title: "FiveThirtyEightReplication_Presentation"
format: html
editor: visual
---
...
```{r}
ggsave("final_plot_wlegend.png", final_plot, bg = "white", dpi = 300)
```
...
```{r}
ggsave("final_improved_plot.png", final_plot, bg = "white", dpi = 300)
```
