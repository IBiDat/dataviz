...
main <- main +
  ...
  annotate("text", x = 9900, y = 66.5, label = "Health expenditure per capita", hjust = 1, family = "ssp", colour = "grey70", size = 5.5) +
  annotate("text", x = 0, y = 84, label = "Life expectancy at birth", hjust = 0, vjust = -1, family = "ssp", colour = "grey70", size = 5.5)
...
note <- ggplot() +
  annotate(
    ...
    x = -0.05, y = .7,
    label = paste(
      "Note: Current health expenditure per capita, purchasing power parity, reflects current international dollars. Both\n",
...
```{r final-plot, fig.width=12, fig.height=8}
