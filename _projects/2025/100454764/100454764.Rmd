...
For my final project I decided to replicate this map created by the Twitter user [terence](https://x.com/researchremora/status/1847607032402075945), known for the amazing maps and visualizations he shares on the platform.

![](images/GaQEh1XXkAAE3zd.jfif)
...
Here is a side by side comparison of the original replication and the alternative version side by side (Need help with this, I don't know why it is not working):

```{r}
final_map + final_map_2.1 
```
