...
![Original chart: Rain Patterns. Source: South China Morning Post (May 22, 2013)](rain-patterns.png){.external width="100%"}
...
rainfall_data <- read_csv2("daily_HKO_RF_ALL_limpia1.csv.gz")
