...
![](images/clipboard-175591426.jpeg){width="589"}
...
|----|----|
| ![](images/clipboard-175591426.jpeg){width="258"} | ![](images/clipboard-3501742140.png){width="258"} |
...
![](images/clipboard-3621868756.gif)
...
final <- final +
  ...
  # title line
  geom_segment(
    x = as.POSIXct("2025-04-27 21:00", tz = "Europe/Madrid"),
    xend = as.POSIXct("2025-04-29 03:00", tz = "Europe/Madrid"),
    y = 43000,
    yend = 43000,
    linewidth = 0.3
...
![](images/clipboard-3042714963.png)
...
![](images/clipboard-3033861489.png)
...
The Rmd makes the file run weirdly, but here is a screenshot of the R file.

![](images/clipboard-442227354.png)
