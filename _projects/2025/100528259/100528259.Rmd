...
Second, after careful exploration, I noticed that there was something wrong with the representation of sports: some sports were not present in the 1960 Summer Olympic games, however they were displayed in the facets that demonstrate 2016 games. Already spotting a defect in the plot, I will try and make an alternative one that is simpler and more meaningful.

Before I go around and spoil all the fun by revealing the ideas, let's proceed to data cleaning and adjusting section.
...
During the improved plot presentation, I received recommendations regarding several aspects of my work. At the end of this document, I will put an evaluation for those recommendations and what I have done to address the issues that were raised.
