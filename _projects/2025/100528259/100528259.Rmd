...
final_graph <-
  ...
  theme(
    ...
    strip.background = element_rect(fill = "gray100", color = NA)
)
...
```{r fig.height=14, fig.width=13, echo=TRUE, preview=TRUE}
final_graph <-
  final_graph +
...
data <- read.csv("/Users/gpen/Dropbox/Mac/Desktop/Version Control/dataviz_gur_piren/athlete_events.csv")
