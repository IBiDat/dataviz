...
#genres_time <- read_tsv("./export_data/genrecnts_time.tsv") 
genres_time <- read_tsv(here::here("export_data", "genrecnts_time.tsv"))
...
I manually placed around 70 labels, writing for each the position on the x and y axis and their sizze, attempting to make it look as close as possible to the original visualization.
