...
description: |
  Map graph with pie charts from Spanish National Atlas (ANE) that shows
  protests motives distribution across spanish provinces in 2022. The
  represented data comes from the 2022 statistical yearbook on protests
  published by the Spanish Ministry of Interior. 
categories: "2025"
...
```{r final_map, fig.width=12, fig.height=7, fig.showtext=TRUE, preview=TRUE}
...
```{r Plotting the final version, fig.width=16, fig.height=10, dpi=150, fig.showtext=TRUE}
...
```{r fig.width=16, fig.height=10, dpi=150, fig.showtext=TRUE}
# Themes 
g <- g + theme_void() +
  theme(
