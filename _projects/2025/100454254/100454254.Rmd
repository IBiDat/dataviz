...
gdp_data_$gdp_mirror <- ifelse(gdp_data_$region == "EAST",
                               -gdp_data_$gdp,
                               gdp_data_$gdp)
```
...
p <- p + geom_area(color = "white", linewidth = .6)
print(p)
```
...
p <- p + scale_x_continuous( # I create a vector of years to adequate it to WSJ.
