...
```{r plot, preview=TRUE, fig.width=8.5, fig.height=12.85, dpi=300, message=FALSE, warning=FALSE}
# Visual tuning 
pt_size   <- 2.6
pt_stroke <- 1.0
ci_lwd    <- 1.05
...
```{r alt1_plot_v5, fig.width=8.5, fig.height=12.85, message=FALSE, warning=FALSE}
pt_size   <- 2.6
pt_stroke <- 1.0
ci_lwd    <- 1.05
dot_lwd   <- 0.35
