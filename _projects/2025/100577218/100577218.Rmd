...
countries_in_view |> 
  filter(grepl("Abyei", NAME_ENGL, ignore.case = TRUE)) |>
  select(NAME_ENGL)
...
create_arc_plot <- function(data, country_name, is_tall = FALSE) {
  ...
  # Add text layers conditionally based on is_tall (the placement of the text differs for 2 of the plots as the names of the countries are longer.)
  if (is_tall) {
    p <- p +
...
# Endpoints
# This makes a dataframe using the final coordinates of the lines as the position of the endpoint
...
# Create white rectangle with text
...
# Position white rectangle on map
...
# Involvement in conflict flags/countries function
...
# Create peacekeeping logos function
