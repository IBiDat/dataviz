...
output:
  distill::distill_article:
    ...
    toc: true
preview: fertility_infographic.png
---
...
![Original chart. **Source:** Iswardi Ishak, 2024](og_graph.png){.external width="100%"}
...
fertility_rate <- read_csv("data/un_fertility_rates.csv.gz")
