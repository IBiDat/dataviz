...
# Create the dataframe for the faster by relative to previous:
...
calgary_legend3 <- calgary_legend2 +
  annotate(
    ...
    y = arrow_bottom, yend = (arrow_bottom + arrow_height),
    color = "#e3cdd5",
    linewidth = 30,
    lineend = "butt",
    arrow = arrow(
      angle = 30,
      length = unit(10, "lines"), # If I interpret documentation correctly,
                                  # will resize as text does
      type = "closed")
  )
