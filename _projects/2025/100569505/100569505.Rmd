...
```{r}
# I could plot two different maps (or some kind of visualization) to plot
# which part of the cities are within a 30 minute radio of Calgary tower
```
...
** I HAVE TO GO, I COULDN'T MAKE THIS WORK YET, HAVE TO FIX THE FORMATS SO THAT I CAN PASS THEM INTO TRAVEL_TIME_MATRIX**
...
# will compute the center of the hexagons:
hexagons <- hexagons |> 
  mutate("center_point" = st_centroid(hexagons$geometry))
...
hexagons
st_coordinates(hexagons$geometry)
?st_centroid
?st_coordinates
hexagons$geometry
# We now need to 
