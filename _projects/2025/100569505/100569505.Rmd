...
v_rectangle_width <- 0.003
v_rectangle_height <- 0.0141
v_rectangle_space <- 0.001
v_rectangle_radius <- 0.3
v_rectangle_fill <- c("#c88c47", "#b7a6ac", "#a36f96", "#6a4886")
v_rectangle_line_color <- "white"
v_rectangle_line_width <- 0.5
...
# black_fastest <-
  ...
  geom_rounded_rect(
    ...
    linewidth = v_rectangle_line_width,
    color = v_rectangle_line_color,
    show.legend = FALSE
  ) +
  scale_fill_identity()
```

Once we have the rectangles, we can plot the legend text relative to them:
...
question_text_h_space <- -0.03 # Relative to vertical rectangles mid x

question_text_size <- 11 
