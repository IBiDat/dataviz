...
library(sf) # Used function st_intersection REDUNDANT?
```
...
rectangle_top <- 50.9600
rectangle_left <- -114.3130
rectangle_width <- 0.0250
rectangle_height <- 0.0050
rectangle_space <- 0.0010
rectangle_color <- c("#aa5312", "#c88c47", "#b7a6ac", "#a36f96", "#6a4886")
