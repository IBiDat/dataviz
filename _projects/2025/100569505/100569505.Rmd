...
```{r transform_isochrones_hexagon_grid_problem, warning=FALSE}
hexagons2 <- hexagons2 |>
...
Next, we add an extra detail, mainly for the aesthetics: we will add a "street arrow" (an arrow made out of actual streets from our map). These "street arrows" come out of the thin rectangles (which act as "main streets"), and point towards the meaning of that color.
