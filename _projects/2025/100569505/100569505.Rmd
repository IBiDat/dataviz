...
```{r load_data}
# Load the data:
# We converted the .geojson files into .csv to upload it following the
# guidelines in order. These were originally the .geojson the author provided.
hexagons <- read_csv("hexagons.csv")
roads <- read_csv("roads.csv")
