...
```{r fig.width=10.66, fig.height=6.35, dpi=300}
...
```{r fig.width=10.66, fig.height=4.4, dpi=300}
graphs <- free(
  p10 + l4 + f10 + r5 +  
  plot_layout(nrow = 1, 
              widths = unit(c(3.42, 
...
```{r fig.width=6.25, fig.height=5, dpi=300}
...
m5 <- m4 + 
  ...
  annotate("text", 
           ...
           hjust = 0,
           color = "#36454F") +
  geom_richtext(aes(x = 2024, y = 294.41,
 ...
 geom_richtext(data = dom_data |> 
            ...
            aes(x = year, 
             ...
             size = 10,
             color = "#3E6548", # If too light 364F4D
             hjust = 1,
             vjust = 1,
             fill = "grey90",
             label.padding = unit(0.1, "lines"))
...
## Bar plot (left graph) 
Domestic 
```{r fig.width=1.75, fig.height=3, dpi=300}
bp1 <- ggplot() +
  scale_x_continuous(limits = c(2029.99, 2030.99),
                     breaks = seq(2030,2031, by = 1)) +
  scale_y_continuous(limits = c(-100, 600),
                     breaks = seq(-100, 600, by = 100)) +
  labs(subtitle = "Domestic Ratings") +
  theme(
    plot.subtitle = element_text(size = 28,
                     colour = "#1D252A"),
    panel.background = element_rect(fill = "grey90",
    ...
    axis.title = element_blank(),
    axis.ticks = element_blank(), 
    plot.margin = margin(0,1.3,0,0.25, unit = "inches")) +
...
# Add labels for colour desc 

bp4 <- bp3 + 
    geom_label(aes(x = 2030.03, y = 310,
                 label = "1.5\u00B0C compatible (< 1.5\u00B0C) "),
             size = 8,
             color = "#3E6548",
             hjust = 0,
             vjust = 0.5,
             ...
             linewidth = 0.25, 
             lineheight = 0.35) +
  geom_label(aes(x = 2030.03, y = 364.61,
                 label = "Almost sufficient (< 2\u00B0C)     "),
             size = 8,
             color = "#756A4F",
             hjust = 0,
             vjust = 0.5,
             ...
             linewidth = 0.25, 
             lineheight = 0.3)+
  geom_label(aes(x = 2030.03, y = 454.350,
                 label = "Insufficient (< 3\u00B0C)   "),
             size = 10,
             color = "#EF963E",
             fontface = "bold",
             hjust = 0,
             ...
             linewidth = 0.25, 
             lineheight = 0.3)+
  geom_label(aes(x = 2030.03, y = 535.51	,
                 label = "Highly insufficient (< 4\u00B0C)    "),
             size = 8,
             color = "#E76E46",
             hjust = 0,
             vjust = 0.6,
             ...
             linewidth = 0.25, 
             lineheight = 0.3)+
  geom_label(aes(x = 2030.03, y = 576.23,
                 label = "Critically insufficient (> 4\u00B0C)"),
             size = 8,
             color = "#B21F1F",
             hjust = 0,
             vjust = 0.5,
...
```{r fig.width=8, fig.height=0.5, dpi=300}
banner_r <- ggplot() +
  theme_void() +
  ...
  annotate("text", x = 0.6, y = 0.7, 
           label = "AUSTRALIA OVERALL RATING",
           color = "#36454F", size = 11) +
  annotate("text", x = 0.6, y = 0.25,
           label = "INSUFFICIENT", 
           color = "#36454F", size = 14, fontface = "bold") +
  coord_cartesian(xlim = c(0,1), ylim = c(0,1))

banner_r
```

## Final Improvement Graph - Add together 

```{r fig.width=8, fig.height=5, dpi=300}

redo <- banner_r / (m7 + bp4 +
    plot_layout(widths = c(6.25,0.2))) + 
  plot_layout(heights = c(0.5, 4.5))
redo
ggsave("redo.png", plot = redo, width = 8, height = 5, units = "in", dpi = 300)
