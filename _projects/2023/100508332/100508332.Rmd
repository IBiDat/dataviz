---
title: "Chart recreation: Women's suffrage across time"
description: |
  The recreation of a graph illustrating the development of the women's suffrage movement across time.This graph is replicated and then improved by adding data describing the development of women's political participation.
categories: "2023"
...
knitr::include_graphics("100508332_files/Original_graph.png")
```
...
data_right_to_vote_unclean <- read.csv("~/Desktop/dataviz/_projects/2023/100508332/country-field_suffrage-field_right_to_vote.csv", header = 7)
```
...
```{r}
data_women_in_parliament_unclean <- read_xlsx("~/Desktop/dataviz/_projects/2023/100508332/women_in_parliament-historical_database-1945_to_2018.xlsx")
