...
![This is the original graph.](images/graph.jpg){.external width="100%"}
...
country <- c("China", "China","India", "India", "U.S", "U.S",
             ...
             "Tanzania", "Tanzania")
#One virtual country was created in orther to have white space between countries as in the original graph
...
```
Depending on the screen size the labels can change their positions. The result I achieved is this one:

![This is the replicated graph.](images/finalPlot.png){.external width="100%"}
...
![This is the alternative graph.](images/alternativePlot.png){.external width="100%"}
