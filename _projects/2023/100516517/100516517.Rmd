...
#nueva_base$Orientacion <- factor(nueva_base$Orientacion, levels = c("Derecha", "Centro", "Izquierda", "Partidos catalanes", "Partidos vascos", "Otros partidos regionales"))
...
graph <- ggplot(data = nueva_base, aes(x = DECIMAL_DATE, y = total_diputados)) +
  ...
  theme(
    ...
    plot.title.position = "plot", #ERICCCCCCCCC TE COMO EL RABO
    ...
    axis.title.x = element_text(size = 5, color = "#6A6A6A", hjust = 0.43), # Cambia el tamaño de letra de los títulos de los ejes
...
ADDING LABELS within each stream
...
#ejes FALTA AJUSTAR 350 DIP Y TICS 
...
graph <- graph + geom_rect(data = data.frame(xmin = 1977.425, xmax = 1980.5, ymin = 1.059, ymax = 1.059),
  ...
  annotate("point", x = 1977.425, y = 1.059, shape = 21, size = 1, colour = "#E6A55B", fill = "#E6A55B")+# Agregar una anotación en forma de punto
  ...
  geom_rect(data = data.frame(xmin = 1981, xmax = 1982.322, ymin = 1.059, ymax = 1.059),
            mapping = aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
            colour = "#E6A55B", fill = "#E6A55B", alpha = 1, size = 0.75, inherit.aes = FALSE)+
  annotate("point", x = 1981, y = 1.059, shape = 21, size = 1, colour = "#E6A55B", fill = "#E6A55B")+# Agregar una anotación en forma de punto
  ...
  annotate("point", x = 1982.822, y = 1.059, shape = 21, size = 1, colour = "#BE4D4C", fill = "#BE4D4C")+# Agregar una anotación en forma de punto
  ...
  annotate("point", x = 1996.169, y = 1.059, shape = 21, size = 1, colour = "#4D76BF", fill = "#4D76BF")+# Agregar una anotación en forma de punto
  ...
  geom_rect(data = data.frame(xmin = 2004.199, xmax = 2011.385, ymin = 1.059, ymax = 1.059),
            mapping = aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
            colour = "#BE4D4C", fill = "#BE4D4C", alpha = 1, size = 0.75, inherit.aes = FALSE)+
  annotate("point", x = 2004.199, y = 1.059, shape = 21, size = 1, colour = "#BE4D4C", fill = "#BE4D4C")+# Agregar una anotación en forma de punto
  ...
  geom_rect(data = data.frame(xmin = 2011.885, xmax = 2018.821, ymin = 1.059, ymax = 1.059),
            mapping = aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
            colour = "#4D76BF", fill = "#4D76BF", alpha = 1, size = 0.75, inherit.aes = FALSE)+
  annotate("point", x = 2011.885, y = 1.059, shape = 21, size = 1, colour = "#4D76BF", fill = "#4D76BF")+# Agregar una anotación en forma de punto
  ...
  geom_rect(data = data.frame(xmin = 2019.321, xmax = 2023, ymin = 1.059, ymax = 1.059),
            mapping = aes(xmin = xmin, xmax = xmax, ymin = ymin, ymax = ymax),
            colour = "#BE4D4C", fill = "#BE4D4C", alpha = 1, size = 0.75, inherit.aes = FALSE)+
  annotate("point", x = 2019.321, y = 1.059, shape = 21, size = 1, colour = "#BE4D4C", fill = "#BE4D4C")+# Agregar una anotación en forma de punto
...
p <- ggplot(mejora_base, aes(DECIMAL_DATE, total_dip)) +
  ...
  scale_color_manual(values = c(
    ...
    "Centro" = "#E89433",
    "Izquierda" = "#BE4D4C",
    "Partidos catalanes" = "#EAC659",
    "Partidos vascos" = "#A1B944",
