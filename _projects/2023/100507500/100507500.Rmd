...
We split the original graph into 2 parts: icons and the rest. We start by building the main plot (bars, etc.). We change the y axis labels manually to match the original graph.
