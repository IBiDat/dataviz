...
description: |
  This article goes through the steps of recreating a bar chart with small multiples using the ggplot2 package in R. The original chart shows the distributions, by age, with whom we spend time. The replication and enhanced versions include new data from the year 2020.  
categories: "2023"
