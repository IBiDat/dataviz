...
```{r setup, include=FALSE, fig.align='center', fig.showtext=TRUE}
...
c_section <- read_delim("tasa_cesareas.csv", 
                 skip = 10, 
                 delim = ";",
                 col_names = c("ccaa", "n_births", "births_hosp_stay", "birth_age", "n_c_section", "c_section_age", "c_section_hosp_stay", "c_section_rate"),
                 locale = my_locale)
...
Uno de los desafíos que presenta nuestro gráfico es la leyenda. Se sitúa arriba y en posición horizontal. Además, los números guía están alineados al centro con los puntos donde cambia el color que indica nuestra tasa. Esto pasa en todos excepto en el primer dato, que está alineado a la izquierda con el inicio de la leyenda.
