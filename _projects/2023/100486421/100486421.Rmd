...
This is my Data visualization project's script. I decided to select Spotify worldwide data about the most listened songs between june and august from Newtral's webpage: https://www.newtral.es/cancion-quevedo-bizarrap/20220825/.
...
There are many render functions to run this animation in different formats. I chose gif as it's easy to handle with Windows and html but there was another good option, av format.
