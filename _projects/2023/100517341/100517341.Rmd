...
YEAH it works. A few things need to be modifed. "A few".
...
```{r  sample table for tooltip, eval=FALSE}
...
```{r testing the function, eval=FALSE}
...
```{r table customization, eval=FALSE}
