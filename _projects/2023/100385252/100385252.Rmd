...
plot <- plot + 
  theme(
    ...
    plot.title = element_text(size = 30, family = "Playfair Display", margin = margin(b=-2, t = -1), vjust = 2.6),
    plot.subtitle = element_text(size = 15, family = "Playfair Display", lineheight = 0.5, color = "#525252"),
    plot.caption = element_text(size = 9, hjust = 0, vjust = -1, color = "#525252",lineheight = 0.8),
    plot.caption.position = "plot",
    axis.title.x = element_text(size = 16, margin = margin(t = 5)),
    axis.title.y = element_text(size = 12, margin = margin(r = 8), vjust = 0.05),
...
## 3 Enhancement and alternative graphs.
...
colors_faced <- c("#EF9A9A", "#FDAE61","#66c2a4")
...
plot3 <- plot3 +
  geom_smooth(method = "lm", se = TRUE, 
              formula = y ~ x, 
              aes(color = as.factor(Year_f)),linewidth = 0.001, linetype = "dashed") 
```
...
plot3 <- plot3 +  guides(color = FALSE, fill = FALSE) +
  scale_x_continuous(
  ...
  theme(
    ...
    plot.title = element_text(size = 25, family = "Playfair Display", margin = margin(b=-2, t = -1), vjust = 2.6),
    plot.subtitle = element_text(size = 15, family = "Playfair Display", lineheight = 0.5, color = "#525252"),
    plot.caption = element_text(size = 12, hjust = 0, vjust = -0.5, color = "#737373"),
    plot.caption.position = "plot",
...
plot3 <- plot3 +
   geom_text_repel(
     data = subset(dataset, label_alternative == "Yes"), 
     aes(label = Country), 
...
plot3 <- plot3 +
  geom_text(
    data = data_text,
    aes(x = x, y = y,label = label), lineheight = 0.7,
