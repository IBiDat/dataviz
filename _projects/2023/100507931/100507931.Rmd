...
Plot <- Plot +
   ...
   geom_line(aes(y = Liberal_Dem, color = "Liberal Dem/Lean Dem"), 
             linetype="solid", size=1.75, alpha = 1, linejoin = "mitre", lineend= "round") +
...
Plot <- Plot +
  theme_minimal() +
       ...
       theme(legend.position = "bottom",
           ...
           legend.text = element_text(family = "almarai", size=16, face = "plain", color ="#4b4647"),
             
        panel.grid = element_blank(),
        panel.grid.major.y = element_line(color = "#E5E5E5"),
        
        plot.title = element_text(face = "bold", family = "franklin", size = 22, hjust = -0.04), 
        
        plot.subtitle = element_text(face = "italic",  colour = "#8d8f8e", family = "playfair", margin = margin(t = 9, b= 30, l=), size =17, hjust = -.05),
        
        plot.caption = element_text(face = "bold", hjust = 0, margin = margin(t = 2, r = 0, b = 0, l = 1), family = "lato", size = 14),
       
        axis.line.x =  element_line(color = "#696969", size = 0.7),
        axis.line.y =  element_line(color = "#a1a1a1", size = 0.5),
        
        axis.text.y = element_text(margin = margin(r=0), size=16, colour = "#696969"),
        axis.text.x = element_text(margin = margin(t=7), size=16, colour = "#696969"),
...
Plot2 <- ggplot(tidy_datos, aes(x = year)) +
  ...
  geom_hline(yintercept =  60,linetype= "dashed", size=.3, color="#696969") +
...
Plot2 <- Plot2 +
  ...
  geom_point(
   ...
   geom_text(data = tidy_datos %>%
      ...
      slice(which.max(mean_cases)),
             aes(x = year, y = mean_cases, color = ideology, label = mean_cases),
             hjust = -.7, vjust = 2, size= 5,  fontface="bold")
...
Plot2 <- Plot2 + 
  ...
  theme( axis.title =element_blank(), 
    ...
    plot.title = element_text(face = "bold", family = "franklin", size = 22),
    
      plot.subtitle = element_text(face = "bold",  colour = "#8d8f8e",  
                                     margin = margin(t = 8, b= 30), size =17)) 
