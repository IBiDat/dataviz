...
```{{r setup, include=FALSE} knitr::opts_chunk$set(out.width="100%", fig.align="center")}
```

## Context on abortion legislation in the U.S.
...
! [Original graph form FiveThirtyEight](original_graph.png){width="100%"}
