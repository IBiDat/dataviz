...
![Source: <https://ourworldindata.org/why-do-women-live-longer-than-men>](images/the_original_graph.png)
...
lifex <- read.csv("C:/Users/alici/OneDrive/Documentos/Clase/Máster/Visualización_de_datos/dataviz_aliciatm/projects/2023/100508665/lifeexpectancy.csv")
...
#Colors of axis, axis text, title
  ...
  theme(
    ...
    theme(
        axis.title.y = element_text(size = 11, family = "Segoe UI Emoji", color = "#5B5B5B", margin = margin(r=10)),
...
#Colors of axis, axis text, title
  ...
  theme(
    ...
    axis.line = element_blank(), #axis lines, colors
      ...
      axis.text.x = element_text(color = "#6C6C6C", family = "Segoe UI Emoji"),
      axis.text.y = element_text(color = "#6C6C6C", family = "Segoe UI Emoji"),
      axis.title.y = element_text(color = "#6C6C6C", family = "Segoe UI Emoji", size = 12, margin = margin(r = 10))) +
