...
description: "Replica and improvement of the map Where do 8 billion people live"
...
```{r}
save(population_by_continent, file = "population_by_continent.RData")
load("population_by_continent.RData")
```
