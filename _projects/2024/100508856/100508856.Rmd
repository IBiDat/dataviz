...
library(ggokabeito)
library(paletteer)
working_hours<-read.csv("C:/annual-working-hours-per-worker.csv")
...
data <- read.csv("C:/annual-working-hours-per-worker.csv")
...
data <- read.csv( "C:/annual-working-hours-vs-gdp-per-capita-pwt.csv")
