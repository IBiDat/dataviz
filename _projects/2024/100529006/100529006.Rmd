...
```{r, layout="l-screen", fig.width=16, fig.height=10, warning=FALSE, preview=TRUE}
...
```{r, layout="l-screen", fig.width=16, fig.height=10, warning=FALSE}
...
```{r, ,layout="l-screen", fig.width=22, fig.height=10, warning=FALSE, message=FALSE}
