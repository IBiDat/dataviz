...
knitr::opts_chunk$set(out.width="1000%", fig.align="center")
```
...
### The others graphs
#### 2° Graph 
The differences between these plots and the first one are minimal, with the only significant changes being in the axis customization. In the second plot, the x-axis does not include custom labels, simplifying its appearance, while the y-axis uses scale_y_continuous() with a custom labeling scheme that only displays "70" and "80" at the higher range of values, leaving the lower values blank.
...
plot3 <- ggplot() +
  ...
  # Add original points using data3
  ...
  # Minimal theme for cleaner visuals
  theme_minimal() +  
  theme(
    panel.grid.major.x = element_blank(),  
    panel.grid.minor = element_blank(),    
...
plot4 <- ggplot() +
  ...
  # Add original points using data4
  ...
  annotate("text", x = 1998, y = 25, label = "Health\ntechnologists and\ntechnicians", 
           size = 4, color = "black", fontface = "plain", hjust = 0.5) +
  annotate("segment", x = 1998, xend = 1998, y = 15.5, yend = 22, 
           color = "black", linewidth = 0.8) +
...
plot5 <- ggplot() +
  ...
  # Add original points using data5
  ...
  annotate("text", x = 1998, y = 21, label = "Police and\ndetectives", 
           size = 4, color = "black", fontface = "plain", hjust = 0.5) +
  annotate("segment", x = 1998, xend = 1998, y = 16.2, yend = 19, 
           color = "black", linewidth = 0.8) +
...
plot6 <- ggplot() +
  ...
  # Add original points using data6
  ...
  annotate("text", x = 1998, y = 28.5, label = "Secretaries", 
           size = 4, color = "black", fontface = "plain", hjust = 0.5) +
  annotate("segment", x = 1998, xend = 1998, y = 25.7, yend = 27, 
           color = "black", linewidth = 0.8) +
...
plot7 <- ggplot() +
  ...
  # Add original points using data7
...
plot9 <- ggplot() +
  ...
  # Add original points using data9
  ...
  annotate("text", x = 1998, y = 31, label = "Production\nsupervisors or\nforemen", 
           size = 4, color = "black", fontface = "plain", hjust = 0.5) +
  annotate("segment", x = 1998, xend = 1998, y = 21.1, yend = 28, 
           color = "black", linewidth = 0.8) +
...
plot10 <- ggplot() +
  ...
  # Add original points using data1
  ...
  scale_y_continuous(
    ...
    position = "right"  # Y-axis labels on the right
  ) +
...
file <- "C:/Users/marco/OneDrive/Desktop/Data Visualization - I sem/Project - The changing nature of middle-class job/Changing nature of middle class.xlsx"
```
```{r remodelling the excel file}
# Get all sheet names
