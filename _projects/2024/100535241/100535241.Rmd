...
```{r original-plot, echo=FALSE, fig.cap="Original graph from ABC article", layout="l-body-outset"}
knitr::include_graphics("~/Documents/UC3M - coursework/Data Vizualisation/dataviz/ABC_tax_income_plot.png")
```
...
We now save the plot created above as a .png to preserve our sizing ratios. If we overlay the raw grob, it distorts when joined to the plots.

```{r save-legendpng, message = FALSE}
png(file="~/Documents/UC3M - coursework/Data Vizualisation/dataviz/legend_test1.png",
...
```{r read-image}
img_path <- "~/Documents/UC3M - coursework/Data Vizualisation/dataviz/legend_test1.png"
...
```{r female-legend-joinplot,layout="l-body-outset", fig.width=12, fig.height=8}
