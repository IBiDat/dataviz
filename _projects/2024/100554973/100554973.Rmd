...
```{r, dpi=500, layout="l-body-outset", fig.width=12, fig.height=10}

#Things to do 
  #Annotate Poland and Armenia/annotate means?
  #Adjust fonts and sizes of text
  #Eliminate the arrow for those that have change little
  #Chamge x-axis title and title, subtitile accordingly (add caption?)
...
improvements <- ggplot(df_lollipop) +
  ...
  geom_point(data = df_lollipop[9, ], 
           aes(x = reorder(country_name, v2x_libdem2022), 
               y = v2x_libdem2012), 
           shape = 1, 
           size = 6, 
           stroke = 1, 
           color = "black") +
  geom_label_repel(data = df_lollipop[9, ],
                   aes(x = reorder(country_name, v2x_libdem2022),
                       y = v2x_libdem2012, 
                       label = "2012",
                       color = "black",
                       size = 3),
                   direction = "y", nudge_y = 0.055,
                   point.padding = 0.9) +
  geom_point(data = df_lollipop[9, ], 
             aes(x = reorder(country_name, v2x_libdem2022), 
                 y = v2x_libdem2022 + 0.003), 
             shape = 1, 
             size = 6, 
             stroke = 1, 
             color = "black") +
  ...
  scale_y_continuous(
    ...
    name = paste("\u2190 less democratic", strrep(" ", 75), "more democratic \u2192")) +
