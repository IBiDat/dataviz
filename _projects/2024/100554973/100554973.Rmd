...
available for download in the [V-Dem's Dataset Archive](https://www.v-dem.net/data/dataset-archive/).
<br>
<br>
...
and transform the countries' names to uppercase.
...
<br>
From the basic graph I highlight selected countries by drawing a bigger line for
those countries and adding their start and end point and their names. In 
particular, when drawing the points I carefully add an outline to them using 
the `stroke` argument of `geom_point`, while for the countries' names I slightly 
