...
description: |
  By recreating from group up a OurWorldinData chart about extreme poverty vs
...
```{r axes-skeleton, layout="l-body-outset",  fig.width = 8, fig.height = 5.8}
...
```{r axes-custom-grid, layout="l-body-outset",  fig.width = 8, fig.height = 5.8}
...
```{r theme, layout="l-body-outset",  fig.width = 8, fig.height = 5.8}
...
```{r titles, layout="l-body-outset",  fig.width = 8, fig.height = 5.8}
# library(ggtext)
...
```{r annotations, layout="l-body-outset",  fig.width = 8, fig.height = 5.8}
...
```{r final, preview = TRUE, layout="l-body-outset",  fig.width = 8, fig.height = 5.8, fig.dpi = 150}
# library(grid)
...
```{r replication, echo=FALSE, layout="l-body-outset"}
knitr::include_graphics(knitr::fig_chunk('final', 'png'))
```
:::
:::
