...
```{r}
#| echo: false
load("~/Desktop/Data Visualization/Economist Data.RData")
```
...
To begin creating my new graph, I first used `maps()` and `sf()` packages to load a US Map, and then added state boundaries.
