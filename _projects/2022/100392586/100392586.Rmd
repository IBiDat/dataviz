...
```{r,  out.width="100%", fig.pos='center', fig.height=5}
a <- a + labs(
...
```{r, fig.pos='center', fig.width=12, fig.height=5}
...
showtext::showtext_opts(dpi=96)#sizes fit better with this option in the gif
