...
```{r}
gdp <- gdp %>% 
mutate(fold = round(gdp_capita_2016/gdp_capita_1950)) %>% 
  mutate(fold = paste(fold,"-fold"),2)
```
...
```{r}
plot<- plot+
    annotate("text", label = "2x richer", color = "blue", x = 30000, y = 60000, angle = 45, size = 1.7,family = "serif")+
    annotate("text", label = "3x richer", color = "blue", x = 20000, y = 60000, angle = 45, size = 1.9,family = "serif")+
    annotate("text", label = "Global average \n growth (4.4x)", color = "blue", x = 15000, y = 70000, angle = 45, size = 1.9,family = "serif")+
    annotate("text", label = "10x richer", color = "blue", x = 8000, y = 65000, angle = 45, size = 1.9,family = "serif")+
    annotate("text", label = "15x richer", color = "blue", x = 5000, y = 65000, angle = 45, size = 1.9,family = "serif")+
    annotate("text", label = "30x richer", color = "blue", x = 2000, y = 68000, angle = 45, size = 1.9,family = "serif")
plot
```
