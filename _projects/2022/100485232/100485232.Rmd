...
description: |
  Visualizing and comparing the loneliness percentage among elders, between different countries, through barplots and maps. 
categories: "2022"
...
an article that tries to prove and explain the importance that social connections 
and personal relationships have in our health.
...
```{r echo=TRUE, fig.height=10, fig.width=12, warning=FALSE}
...
```{r echo=TRUE, fig.height=6, warning=FALSE}
#above code chunk to extend graph height, and make it longer
...
axe, because it is repeating information that is already in the graph.
