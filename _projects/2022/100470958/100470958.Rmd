...
![The Economist's chart](the_economist_gdp_growth_estimates.png "The Ecnomist's chart")
...
In our chart, the Y-axis shows the officialy reported GDP growth, while the X-axis illustrates the NTL-based estimate of GDP. As a result, we should expect that each county will be located in the intersection line where Y is equal to X. However, the autocratic countries are far away from this line, as their the value of the officialy reported GDP.
