...
data %>% ggplot() +
  ...
  annotate("text", label="Facebook", y=69, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="Instagram", y=43, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="Pinterest", y=36, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="LinkedIn", y=31, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="Snapchat", y=25, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="Twitter", y=22.5, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="WhatsApp", y=20, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="TikTok", y=18, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="Reddit", y=15, x=2021, hjust=-0.8, size=3) +
  annotate("text", label="Nextdoor", y=10, x=2021, hjust=-0.8, size=3) +
