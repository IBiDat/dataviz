...
data %>% ggplot() +
  ...
  theme(
    ...
    plot.caption = element_text(hjust = 0, family = "League Gothic", color = "grey", size = 9),
    aspect.ratio = 1/1.6,
    plot.subtitle = element_text(family = "Georgia", color = "grey", size = 8),
    plot.title = element_text(family = "League Gothic", hjust = 0, size = 17),
