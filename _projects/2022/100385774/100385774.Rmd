...
new %>% ggplot() +
  ...
  theme(
    ...
    axis.text.y.left = element_text(color = colors, family = "Franklin Gothic", size = 10),
...
"platforms among U.S. adults"),
       ...
       '\n"Social media use in 2021"'),
        x = "% evolution") +
  annotate("text", label = "PEW RESEARCH CENTER", family = "Franklin Gothic", x=-10, y = 0, vjust = 12.5, hjust=0.16, size = 3.5) ++
  gghighlight::aes() +
