...
So, with less complexity we've displayed the most important information that the article makes reference to, also reducing the used years to the last 4, that are also the most relevant ones, as the title says. 


```{r, out.height="0%%", out.width="0%"}
