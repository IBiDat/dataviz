...
data %>% ggplot() +
  ...
  theme(
    ...
    axis.text.x.bottom = element_text(color="grey", family = "League Gothic"),
    axis.text.y.left = element_text(color="grey", family = "League Gothic"),
    axis.line.x.bottom = element_line(color="transparent"),
    axis.ticks.length = unit(0, "pt"),
    axis.ticks.length.x.bottom = unit(5, "pt"),
    plot.caption = element_text(hjust = 0, family = "League Gothic", color = "grey"),
    aspect.ratio = 1/1.6,
    plot.subtitle = element_text(family = "Georgia", color = "grey", size = 8),
    plot.title = element_text(family = "League Gothic", hjust = 0),
    #plot.title.position = c(1,1),
    plot.tag.position = c(0,0),
    plot.tag = element_text(family = "League Gothic", color = "black", size = 10, hjust = -0.24, vjust = 2),
    plot.margin = margin(0,3,3,0, unit = "cm"),
  ) +
  annotate("text", label="YouTube", y=81, x=2021, hjust=-0.8, size=2.5, family = "League Gothic", color = "#bf4538") +
  annotate("text", label="Facebook", y=69, x=2021, hjust=-0.7, size=2.5, family = "League Gothic", color = "#23689a") +
  annotate("text", label="Instagram", y=43, x=2021, hjust=-0.7, size=2.5, family = "League Gothic", color = "#6c9acf") +
  annotate("text", label="Pinterest", y=36, x=2021, hjust=-0.75, size=2.5, family = "League Gothic", color = "#747a46") +
  annotate("text", label="LinkedIn", y=31, x=2021, hjust=-0.8, size=2.5, family = "League Gothic", color = "#c2c88e") +
  annotate("text", label="Snapchat", y=25, x=2021, hjust=-0.68, size=2.5, family = "League Gothic", color = "#746a7c") +
  annotate("text", label="Twitter", y=22.5, x=2021, hjust=-1, size=2.5, family = "League Gothic", color = "#d1aa42") +
  annotate("text", label="WhatsApp", y=20, x=2021, hjust=-0.65, size=2.5, family = "League Gothic", color = "#253a5c") +
  annotate("text", label="TikTok", y=18, x=2021, hjust=-1, size=2.5, family = "League Gothic", color = "#e9a03f") +
  annotate("text", label="Reddit", y=15, x=2021, hjust=-1.05, size=2.5, family = "League Gothic", color = "#92885a") +
  annotate("text", label="Nextdoor", y=10, x=2021, hjust=-0.75, size=2.5, family = "League Gothic", color = "#e28377") +
