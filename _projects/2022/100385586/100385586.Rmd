...
```{r}
breaks_x <- c(1.4, 4.15, 5.8, 9.6)
breaks_y <- c(1.7, 5, 6.5, 9.5)
...
p <- ggplot(religion) + 
  ...
  theme_classic()+  
  theme(
    plot.title = element_text(face = "bold", family = "playfair display"),
    plot.subtitle = element_text(face = "italic", family = "playfair display"),
    axis.title.x = element_text(face = "bold"), 
    axis.title.y = element_text(face = "bold", vjust = 1, hjust = 0.45), 
    axis.text.x = element_text(hjust = 1.8), 
    axis.text.y = element_text(angle = 90, hjust = 1.9), 
