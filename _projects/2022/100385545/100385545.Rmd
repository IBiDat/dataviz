...
```{r}
# install.packages(c("tidyverse", "ggplot2", "cowplot", "magrittr", "ggpubr", "sysfonts", "shoxtext")
library(tidyverse)
library(ggplot2)
library(cowplot)
library(magrittr)
...
p <- p + labs(
  ...
  annotate("text", x = 2, y = 21, label = "Male", size = 3, color = "#eb9f2e", fontface = 2, family = "Arimo") +
  annotate("text", x = 16, y = 21, label = "Female", size = 3, color = "#83669f", fontface = 2, family = "Arimo") 
...
```{r}
p <- p +
  annotate("rect", xmin = 3.05, xmax = 3.2, ymin = 4.65, ymax = 5.3, alpha = 1, color = "#eb9f2e", fill = "#eb9f2e") +
  annotate("rect", xmin = 4.05, xmax = 4.2, ymin = 3.65, ymax = 4.3, alpha = 1, color = "#eb9f2e", fill = "#eb9f2e") 
...
p <- p + theme_light() +
  ...
  plot.subtitle = element_text(color = "grey", face = "italic", family = "Tinos", hjust = 0, vjust = 4),
...
p <- p + expand_limits(y = -1.5) +
  annotate("text", x = 1, y = 0, label = "1st", size = 3.25, color = "#76777a", fontface = 1, family = "Tinos") +
  annotate("text", x = 4, y = 0, label = "4th", size = 3.25, color = "#76777a", fontface = 1, family = "Tinos") +
  annotate("text", x = 8, y = 0, label = "8th", size = 3.25, color = "#76777a", fontface = 1, family = "Tinos") +
  annotate("text", x = 12, y = 0, label = "12th", size = 3.25, color = "#76777a", fontface = 1, family = "Tinos") +
  annotate("text", x = 16, y = 0, label = "16th", size = 3.25, color = "#76777a", fontface = 1, family = "Tinos") +
  annotate("text", x = 1, y = 0.5, label = "|", size = 2, color = "#76777a", fontface = 1, family = "Arimo") +
  annotate("text", x = 4, y = 0.5, label = "|", size = 2, color = "#76777a", fontface = 1, family = "Arimo") +
  annotate("text", x = 8, y = 0.5, label = "|", size = 2, color = "#76777a", fontface = 1, family = "Arimo") +
  annotate("text", x = 12, y = 0.5, label = "|", size = 2, color = "#76777a", fontface = 1, family = "Arimo") +
  annotate("text", x = 16, y = 0.5, label = "|", size = 2, color = "#76777a", fontface = 1, family = "Arimo")
p
```
...
```{r, out.width="100%"}
a_df <- data.frame(Profession = c("CEO", "Professor", "Electrical engineer", "Security guard", "Banker", "Blank", "Clergy", "Industrial engineer", "Bartender", "Musician", "Chef", "Movie director", "Police", "Athlete", "Medical scientist", "Physician", "Blank", "Pharmacist", "Nurse", "Clerk", "Customer service rep.", "Housekeeper"),
...
f_df <- a_df %>% slice(1:(n()-11)) %>% mutate(position15 = c(10, 10, 10, 10, 10, NA, 10, 11, 11, 10, 10))

fo_df <- a_df %>% slice(12:n()) %>% mutate(position15 = c(10, 10, 10, 10, 10, NA, 10, 10, 10, 10, 10)) %>% mutate(position5 = c(NA, NA, NA, NA, NA, NA, 12, 12, 11, 11, NA)) %>% mutate(position16 = c(1, 1, NA, NA, NA, NA, 1, 1, NA, NA, NA))
...
```{r}
f_df$Profession <- factor(f_df$Profession, levels = c("Professor", "CEO", "Electrical engineer", "Banker", "Security guard", "Blank",  "Clergy", "Industrial engineer", "Bartender", "Musician", "Chef" ))
...
p1 <- ggplot(f_df, aes(x = Profession)) + 
  ...
  annotate("text", x = 6, y = 15, label = "Male", size = 3.5, color = "#eb9f2e", fontface = 1, family = "poppins") +
  annotate("text", x = 6, y = 9.05, label = "Female", size = 3.5, color = "#83669f", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 16, label = "1st", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 13, label = "4th", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 9, label = "8th", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 5, label = "12th", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 1, label = "16th", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.5, y = 16, label = "—", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.5, y = 13, label = "—", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.5, y = 9, label = "—", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.5, y = 5, label = "—", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.5, y = 1, label = "—", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 1, y = 17.2, label = "Professor", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 2, y = 18.2, label = "CEO", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 3, y = 17.2, label = "Electrical eng.", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 4, y = 18.2, label = "Banker", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 5, y = 17.2, label = "Security guard", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 7, y = 17.2, label = "Clergy", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 8, y = 18.2, label = "Industrial eng.", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 9, y = 17.2, label = "Bartender", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 10, y = 18.2, label = "Musician", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 11, y = 17.2, label = "Chef", size = 3, color = "black", fontface = 1, family = "poppins") +
  ...
  plot.subtitle = element_text(color = "grey", face = "italic", family = "poppins", hjust = .5, vjust = 4),
  plot.caption = element_text(hjust = 0),
  axis.title = element_blank()
)
```
...
fo_df$Profession <- factor(fo_df$Profession, levels = c("Movie director", "Police", "Athlete", "Medical scientist", "Physician", "Blank", "Pharmacist", "Nurse", "Clerk", "Cust. serv. rep.", "Housekeeper"))
...
p2 <- ggplot(fo_df, aes(x = Profession)) + 
  ...
  scale_fill_manual(values=c(position ="white",
                             ...
                             Female = "#83669f")) +
  scale_x_discrete(position = "top", guide = guide_axis(n.dodge=2)) +
  annotate("rect", xmin = 7, xmax = 7.35, ymin = 13.6, ymax = 14.4, alpha = 1, color = "#eb9f2e", fill = "#eb9f2e") +
  annotate("rect", xmin = 8, xmax = 8.35, ymin = 12.6, ymax = 13.4, alpha = 1, color = "#eb9f2e", fill = "#eb9f2e") +
  #expand_limits(x = 0.25, ) +
  annotate("text", x = 6, y = 15, label = "Male", size = 3.5, color = "#eb9f2e", fontface = 1, family = "poppins") +
  annotate("text", x = 6, y = 14.05, label = "Female", size = 3.5, color = "#83669f", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 16, label = "1st", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 13, label = "4th", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 9, label = "8th", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.1, y = 5, label = "12th", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  ...
  annotate("text", x = 0.5, y = 5, label = "—", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 0.5, y = 1, label = "—", size = 3.25, color = "#6d6e71", fontface = 1, family = "poppins") +
  annotate("text", x = 1, y = 17.2, label = "Movie director", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 2, y = 18.2, label = "Police", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 3, y = 17.2, label = "Athlete", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 4, y = 18.2, label = "Medical scientist", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 5, y = 17.2, label = "Physician", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 7, y = 17.2, label = "Pharmacist", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 8, y = 18.2, label = "Nurse", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 9, y = 17.2, label = "Clerk", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 10, y = 18.2, label = "Cust. serv. rep.", size = 3, color = "black", fontface = 1, family = "poppins") +
  annotate("text", x = 11, y = 17.2, label = "Housekeeper", size = 3, color = "black", fontface = 1, family = "poppins") +
  ...
  #axis.text.y = element_blank(),
  plot.title = element_text(face = "bold", family = "poppins", hjust = 0.5),
  plot.subtitle = element_text(color = "grey", face = "italic", family = "poppins", hjust = .5, vjust = 2),
  plot.caption = element_text(hjust = 0),
  axis.title = element_blank()
)
```

I created also an empty ggplot2 to plot the title because plotting with the first graph makes the display of the graph irregular and different from the second one. 

```{r}
empty <- data.frame(Profession = c(15,15,15),
                    Male = c(15,15,15),
                    Female = c(15,15,15))

emp <- ggplot(empty, aes(x = Profession)) + 
  geom_tile(aes(y=Male), fill="white", color = "white") + 
  geom_tile(aes(y=Female), fill="white", color = "white") +
  labs(
    x = "",
    y = "",
...
And finally, here we have our alternative visualization, merging the three previous plots:
