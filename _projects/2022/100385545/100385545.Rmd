...
p <- p + expand_limits(y = -1.5) +
  annotate("text", x = 1, y = 0, label = "1st", size = 3.25, color = "#76777a",
           fontface = 1, family = "tinos") +
  annotate("text", x = 4, y = 0, label = "4th", size = 3.25, color = "#76777a",
           fontface = 1, family = "tinos") +
  annotate("text", x = 8, y = 0, label = "8th", size = 3.25, color = "#76777a",
           fontface = 1, family = "tinos") +
  annotate("text", x = 12, y = 0, label = "12th", size = 3.25, color = "#76777a",
           fontface = 1, family = "tinos") +
  annotate("text", x = 16, y = 0, label = "16th", size = 3.25, color = "#76777a",
           fontface = 1, family = "tinos") +
  annotate("text", x = 1, y = 0.5, label = "|", size = 2, color = "#76777a",
           fontface = 1, family = "arimo") +
  annotate("text", x = 4, y = 0.5, label = "|", size = 2, color = "#76777a",
           fontface = 1, family = "arimo") +
  annotate("text", x = 8, y = 0.5, label = "|", size = 2, color = "#76777a",
           fontface = 1, family = "arimo") +
  annotate("text", x = 12, y = 0.5, label = "|", size = 2, color = "#76777a",
           fontface = 1, family = "arimo") +
  annotate("text", x = 16, y = 0.5, label = "|", size = 2, color = "#76777a",
           fontface = 1, family = "arimo")
p
```
...
p1 <- ggplot(f_df, aes(x = Profession)) + 
  ...
  annotate("text", x = 0.5, y = 1, label = "—", size = 3.25, color = "#6d6e71",
           fontface = 1, family = "poppins") +
  annotate("text", x = 1, y = 17.2, label = "Professor", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 2, y = 18.2, label = "CEO", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 3, y = 17.2, label = "Electrical eng.", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 4, y = 18.2, label = "Banker", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 5, y = 17.2, label = "Security guard", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 7, y = 17.2, label = "Clergy", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 8, y = 18.2, label = "Industrial eng.", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 9, y = 17.2, label = "Bartender", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 10, y = 18.2, label = "Musician", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 11, y = 17.2, label = "Chef", size = 3, color = "black",
           fontface = 1, family = "poppins") +
...
p2 <- ggplot(fo_df, aes(x = Profession)) + 
  ...
  annotate("text", x = 0.5, y = 1, label = "—", size = 3.25, color = "#6d6e71",
           fontface = 1, family = "poppins") +
  annotate("text", x = 1, y = 17.2, label = "Movie director", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 2, y = 18.2, label = "Police", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 3, y = 17.2, label = "Athlete", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 4, y = 18.2, label = "Medical scientist", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 5, y = 17.2, label = "Physician", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 7, y = 17.2, label = "Pharmacist", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 8, y = 18.2, label = "Nurse", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 9, y = 17.2, label = "Clerk", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 10, y = 18.2, label = "Cust. serv. rep.", size = 3, color = "black",
           fontface = 1, family = "poppins") +
  annotate("text", x = 11, y = 17.2, label = "Housekeeper", size = 3, color = "black",
           fontface = 1, family = "poppins") +
