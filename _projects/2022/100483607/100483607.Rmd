...
![J.Aguirre \| EL MUNDO GRÁFICOS. Figure from [elmundo.es](https://elmundo.es).](ccaa470.jpg){.external}
...
```{r, fig.height = 12, fig.width = 4, fig.align = "center"}
...
![P.Arroyo \| MUCSS.](Grafico_Definitivo.png){.external}
...
t<- t + annotate(geom = "text", x = 20.5, y = -1500,
  ...
  annotate(geom = "rect", xmin = 20.25, xmax = 20,
           ymin = 500, ymax = 700, fill = "#22823a", alpha = 1)+ #Color PNV
  annotate(geom = "rect", xmin = 20.25, xmax = 20,
           ymin = 1500, ymax = 1700, fill = "#f3af44", alpha = 1)+ #Color ERC
  annotate(geom = "rect", xmin = 20.25, xmax = 20,
