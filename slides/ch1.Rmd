...
.center[![](assets/img/ch1/history-priestley.gif)]
...
.center[![:scale 80%](assets/img/ch1/history-playfair-bar.jpg)]
...
.center[![:scale 80%](assets/img/ch1/history-playfair-timeseries.png)]
...
.center[![](assets/img/ch1/history-playfair-pie.jpg)]
...
.center[![:scale 90%](assets/img/ch1/history-nightingale.jpg)]
...
.center[![:scale 60%](assets/img/ch1/history-snow.jpg)]
...
.center[![](assets/img/ch1/history-minard.png)]
...
.center[![](assets/img/ch1/example-tictactoe.png)]
]
]
...
![](assets/img/ch1/example-anscombe.svg)

---

# Example: Datasaurus

![](assets/img/ch1/example-datasaurus.jpeg)
...
.center[![](assets/img/ch1/example-preattentive.png)]
]
.panel[.panel-name[Serial search]
.center[![](assets/img/ch1/example-serial.png)]
]
]
...
.pull-right.center[
![](assets/img/ch1/example-illusion.jpg)
]
...
.center[![:scale 80%](assets/img/ch1/example-representation.jpg)]
...
.center[![:scale 80%](assets/img/ch1/example-mapping.png)]
...
.center[![](assets/img/ch1/bad-pie1.png)]
]
.panel[.panel-name[Second try]
.center[![](assets/img/ch1/bad-pie2.png)]
]
.panel[.panel-name[The only acceptable one]
.center[![](assets/img/ch1/bad-pie3.png)]
]
]
...
.panelset[
.panel[.panel-name[See the pattern?]
.center[![](assets/img/ch1/bad-area1.png)]
]
.panel[.panel-name[Second try]
.center[![](assets/img/ch1/bad-area2.png)]
]
]
...
![:vspace 50]()
.pull-left[.center[![](assets/img/ch1/bad-bar1.png)]]
.pull-right[.center[![](assets/img/ch1/bad-bar2.png)]]
]
.panel[.panel-name[Deception 2]
.center[![](assets/img/ch1/bad-bar3.png)]
]
.panel[.panel-name[Ineptitude 1]
.center[![](assets/img/ch1/bad-bar4.png)]
]
.panel[.panel-name[Ineptitude 2]
- Some well-intentioned axis cuts may have nefarious consequences

![:vspace 50]()
.pull-left[.center[![](assets/img/ch1/bad-bar5.png)]]
.pull-right[.center[![](assets/img/ch1/bad-bar6.png)]]
]
]
...
.center[![](assets/img/ch1/bad-data1.png)]
]
.panel[.panel-name[Irrelevant data]
.center[![](assets/img/ch1/bad-data2.jpg)]
]
.panel[.panel-name[Bonus]
.center[![:scale 80%](assets/img/ch1/bad-data3.jpg)]
]
.panel[.panel-name[Non-comparable]
.center[![](assets/img/ch1/bad-data4.png)]
]
.panel[.panel-name[Not related]
.center[![](assets/img/ch1/bad-data5.png)]
...
.center[![](assets/img/ch1/bad-many1.jpg)]
]
.panel[.panel-name[Pie horror 2]
.center[![](assets/img/ch1/bad-many2.png)]
]
]
...
.center[![](assets/img/ch1/bad-little1.png)]
]
.panel[.panel-name[Optimist 2]
.center[![](assets/img/ch1/bad-little2.png)]
]
.panel[.panel-name[Scientific optimist]
.center[![](assets/img/ch1/bad-little3.png)]
]
.panel[.panel-name[+bad interpretation]
.center[![](assets/img/ch1/bad-little4.png)]
]
]
...
![:vspace 50]()
.center[![](assets/img/ch1/bad-hide1.png)]
]
.panel[.panel-name[More context]
![:vspace 50]()
.center[![](assets/img/ch1/bad-hide2.png)]
]
.panel[.panel-name[Complete picture]
![:vspace 50]()
.center[![](assets/img/ch1/bad-hide3.png)]
]
.panel[.panel-name[Context!]
.center[![](assets/img/ch1/bad-hide4.png)]
]
]
...
.center[![](assets/img/ch1/bad-wrong1.png)]
]
.panel[.panel-name[Level 2]
.center[![](assets/img/ch1/bad-wrong2.png)]
]
.panel[.panel-name[Level 3]
.center[![](assets/img/ch1/bad-wrong3.png)]
]
.panel[.panel-name[Level 4]
.center[![](assets/img/ch1/bad-wrong4.jpg)]
]
.panel[.panel-name[Level 5]
.center[![](assets/img/ch1/bad-wrong5.jpg)]
]
.panel[.panel-name[Level 6]
.center[![](assets/img/ch1/bad-wrong6.jpg)]
]
]
...
.panelset[
.panel[.panel-name[Level 1]
.center[![](assets/img/ch1/bad-creativity1.png)]
]
.panel[.panel-name[Level 2]
.center[![](assets/img/ch1/bad-creativity2.png)]
]
.panel[.panel-name[Level 3]
.center[![](assets/img/ch1/bad-creativity3.png)]
]
.panel[.panel-name[Level 4]
.center[![](assets/img/ch1/bad-creativity4.png)]
]
.panel[.panel-name[Level 5]
.center[![](assets/img/ch1/bad-creativity5.png)]
]
.panel[.panel-name[Level 6]
.center[![:scale 60%](assets/img/ch1/bad-creativity6.png)]
]
]
...
.panelset[
.panel[.panel-name[3D]
.center[![](assets/img/ch1/bad-scientific1.jpg)]
]
.panel[.panel-name[Linear relationship?]
.center[![](assets/img/ch1/bad-scientific2.jpg)]
]
.panel[.panel-name[Quadratic relationship?]
.center[![:scale 60%](assets/img/ch1/bad-scientific3.jpg)]
]
.panel[.panel-name[Other?]
.center[![:scale 60%](assets/img/ch1/bad-scientific4.jpg)]
]
.panel[.panel-name[Whatever]
.center[![:scale 60%](assets/img/ch1/bad-scientific5.jpg)]
]
]
...
.center[![:scale 60%](assets/img/ch1/rethinking11.jpg)]
]
.panel[.panel-name[Iteration 1]
.center[![:scale 60%](assets/img/ch1/rethinking12.png)]
]
.panel[.panel-name[Iteration 2]
.center[![:scale 52%](assets/img/ch1/rethinking13.png)]
]
]
...
.panelset[
.panel[.panel-name[Original]
.center[![:scale 70%](assets/img/ch1/rethinking21.png)]
]
.panel[.panel-name[Iteration 1]
.center[![](assets/img/ch1/rethinking22.png)]
]
.panel[.panel-name[Iteration 2]
.center[![:scale 45%](assets/img/ch1/rethinking23.png)]
]
]
...
.panelset[
.panel[.panel-name[Original]
.center[![](assets/img/ch1/rethinking31.png)]
]
.panel[.panel-name[Original]
.center[![:scale 40%](assets/img/ch1/rethinking32.png)]
]
.panel[.panel-name[Iteration 1]
.center[![:scale 40%](assets/img/ch1/rethinking33.png)]
]
]
...
.panelset[
.panel[.panel-name[Original]
.center[![:scale 33%](assets/img/ch1/rethinking41.png)]
]
.panel[.panel-name[Iteration 1]
.center[![:scale 62%](assets/img/ch1/rethinking42.png)]
]
]
...
.panelset[
.panel[.panel-name[Original]
.center[![](assets/img/ch1/rethinking51.png)]
]
.panel[.panel-name[Iteration 1]
.center[![:scale 75%](assets/img/ch1/rethinking52.png)]
]
.panel[.panel-name[A word of caution]
.center[![](assets/img/ch1/rethinking53.png)]
]
]
...
.panelset[
.panel[.panel-name[Original]
.center[![:scale 78%](assets/img/ch1/rethinking61.png)]
]
.panel[.panel-name[Iteration 1]
.center[![:scale 75%](assets/img/ch1/rethinking62.png)]
]
]
...
.panelset[
.panel[.panel-name[Original]
.center[![:scale 78%](assets/img/ch1/rethinking71.png)]
]
.panel[.panel-name[Iteration 1]
.center[![:scale 43%](assets/img/ch1/rethinking72.png)]
]
]
...
.panelset[
.panel[.panel-name[Original]
.center[![:scale 97%](assets/img/ch1/rethinking81.png)]
]
.panel[.panel-name[Iteration 1]
.center[![:scale 84%](assets/img/ch1/rethinking82.png)]
]
]
...
.center[![:scale 100%](assets/img/ch1/perception-example0.png)]
].pull-right[
- **Encoding rules**:
  - sale => point
...
.center[![:scale 100%](assets/img/ch1/perception-example1.png)]
].pull-right[
- **Encoding rules**:
...
.center[![:scale 70%](assets/img/ch1/perception-marks.png)]
...
.center[![:scale 70%](assets/img/ch1/perception-channels.png)]
...
.center[![:scale 100%](assets/img/ch1/perception-example2.png)]
...
.center[![:scale 100%](assets/img/ch1/perception-example3.png)]
...
.center[![:scale 90%](assets/img/ch1/perception-exercise1.png)]
]
.panel[.panel-name[2]
.footnote[Source: [Gapminder](https://www.gapminder.org)]
.center[![:scale 80%](assets/img/ch1/perception-exercise2.png)]
]
.panel[.panel-name[3]
.footnote[Source: [Fathom](https://fathom.info/salaryper/)]
.center[![:scale 75%](assets/img/ch1/perception-exercise3.png)]
]
.panel[.panel-name[4]
...
.center[![:scale 80%](assets/img/ch1/perception-example4.png)]
...
.center[![:scale 100%](assets/img/ch1/perception-ranks.png)]
...
.center[![:scale 55%](assets/img/ch1/perception-steven.png)]

---

# Channel Effectiveness: Accuracy

.center[![:scale 80%](assets/img/ch1/perception-experiments.png)]
...
.center[![:scale 100%](assets/img/ch1/perception-example5.png)]
...
.pull-left[
.center[![:scale 100%](assets/img/ch1/perception-example6.png)]
]

.pull-right[
.center[![:scale 100%](assets/img/ch1/perception-example7.png)]
]
...
.pull-left[
.center[![:scale 100%](assets/img/ch1/perception-example8.png)]
]

.pull-right[
.center[![:scale 100%](assets/img/ch1/perception-example9.png)]
]
...
.center[![:scale 100%](assets/img/ch1/perception-separability.png)]
...
.center[
![:scale 32%](assets/img/ch1/perception-example10.png)
![:scale 32%](assets/img/ch1/perception-example11.png)
![:scale 32%](assets/img/ch1/perception-example12.png)
]
...
.center[![:scale 100%](assets/img/ch1/perception-example13.jpg)]
...
.pull-right[
.center[![:scale 100%](assets/img/ch1/perception-popout.png)]
]

---

# Channel Effectiveness: Separability, Popout
...
.pull-right[
.center[![:scale 100%](assets/img/ch1/perception-grouping.png)]
]
