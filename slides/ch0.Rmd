...
- **Session 03-07**: Chapter 2. The Grammar of Graphics

- **Session 09-10**: Chapter 3. Data Visualization in R

- **Session 08, 11-12**: Chapter 4. Data Communication in R

- **Session 13-14**: Discussion and Evaluation
  <br>![:hspace 117]()⟶ (Dec 10) Student presentations 1
  <br>![:hspace 117]()⟶ (Dec 17) Student presentations 2
...
- **Session 01-14**: Wednesday, 15-18 h, room 2.A.04
...
### **25%** Participation + **75%** Final project
...
- **S2. Presentations**: (*may* be in Rmd) + questions (5 + 5 min. each)
- **S3. Feedback**: Pull Request (PR) review and merge

<pre class="mermaid" style="zoom:1.1;background:#FAFAFA">
gantt
  dateFormat YYYY-MM-DD
  axisFormat %b %d
  weekday monday
  tickInterval 2week
  excludes 2025-12-20, 2025-12-21, 2025-12-22, 2025-12-23, 2025-12-24, 2025-12-25, 2025-12-26, 2025-12-27, 2025-12-28, 2025-12-29, 2025-12-30, 2025-12-31, 2026-01-01, 2026-01-02, 2026-01-03, 2026-01-04, 2026-01-05, 2026-01-06, 2026-01-07
  ...
  section Submission
    S1 :2025-11-24, 3w
    S2 :2025-12-10, 8d
    PR opened :milestone, v1, 2025-12-15, 1d
    S3 :2025-12-15, 12d
    PR merged :milestone, v2, 2026-01-14, 1d
</pre>
